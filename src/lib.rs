// src/lib.rs
/*
 * Core library for OpcodeDebugger
 */
...
#[derive(Debug)]
pub struct OpcodeDebuggerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OpcodeDebuggerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OpcodeDebugger processing");
    
    let mut processor = OpcodeDebuggerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OpcodeDebuggerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OpcodeDebuggerProcessor::new(false);
